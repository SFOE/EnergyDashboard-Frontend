...
@Component({
    selector: 'bfe-preise-treibstoff-benzin',
    templateUrl: './preise-treibstoff-benzin.component.html',
    styleUrls: ['./preise-treibstoff-benzin.component.scss']
})
export class PreiseTreibstoffBenzinComponent {
    readonly primaryColor = COLOR_OEL;
    readonly legendEntries: DiagramLegendEntry[] = [
        {
            color: this.primaryColor,
            labelKey: 'dashboard.preise.benzin.legend.index-preis',
            type: 'line'
        }
    ];
