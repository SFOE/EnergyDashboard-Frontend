...
@Component({
    selector: 'bfe-stromverbrauch-aktueller-landesverbrauch-histogram-chart',
    templateUrl:
        './stromverbrauch-aktueller-landesverbrauch-histogram-chart.component.html',
    styleUrls: [
        './stromverbrauch-aktueller-landesverbrauch-histogram-chart.component.scss'
    ]
})
export class StromverbrauchAktuellerLandesverbrauchHistogramChartComponent
    implements OnInit
{
    ...
    readonly lineEntries: DiagramLegendEntry[] = [
        ...
        },
        {
            ...
            labelKey: 'dashboard.strom.verbrauch-daily.legend.estimated-usage',
            type: 'line'
        },
        {
            color: COLOR_CHART_STROM_ADDITIONAL_LINE,
            labelKey: 'dashboard.strom.verbrauch-daily.legend.prognosis',
            type: 'dashed-line'
        }
    ];
